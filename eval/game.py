...
class Episode:
    ...
    def save(self):
        ...
        with open("results.csv", "a") as f:
            f.write(
                f"{timestamp},{LANG},{self.player_1.model},"
                + f"{self.player_2.model},{self.player_1_won}\n"
            )
            ...
            while True:
                ...
                if p1_wins == 1 or p2_wins == 1:
                    ...
                    if episode.player_1_won:
                        print(
                            f"[red] Player1 {self.player_1.nickname} {self.player_1.robot.model} won!"
                        )
                        print(
                            f"[green] Player2 {self.player_2.nickname} {self.player_2.robot.model} lose!"
                        )
                    else:
                        print(
                            f"[red] Player1 {self.player_1.nickname} {self.player_1.robot.model} lose!"
                        )
                        print(
